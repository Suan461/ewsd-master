...
$txtTodayDate=$_POST['txtTodayDate'];



//Student Image Upload Coding Start--------------------------
    $StudentImage=$_FILES['StudentImage']['name']; 
    $folder="images/StudentImages/";

    $filename=$folder . "_" . $StudentImage; 

    $copied=copy($_FILES['StudentImage']['tmp_name'], $filename);
...
//Student ID card Image Upload Coding Start--------------------------
    ...
    $Folder="images/StudentidImages/";

    $filename1=$Folder . "_" . $StudentidImages; 

    $copied1=copy($_FILES['StudentidImages']['tmp_name'], $filename1);
...
$select="SELECT * from students 
		where student_email='$txtStudentEmail'
        and student_password='$txtStudentPassword'
        or student_username='$txtStudentUsername'";
...
$insert="INSERT INTO `students`
        (`student_name`, `student_username`, `student_email`, `student_password`, `faculty_id`, `student_profile_img_url`, `student_id_img_url`,`student_is_approved`, `student_dob`, 
        `student_address`, `gender_id`, `student_created_at`,`StudentGUID`) 
